...
def fetch_who_global_data(url: str) -> pd.DataFrame:
    ...
    try:
        ...
        african_countries = [
            ...
            "Chad", "Comoros", "Congo (Congo-Brazzaville)", "Congo (Congo-Kinshasa)", "Djibouti", "Egypt", "Equatorial Guinea", "Eritrea",
            "Eswatini (fmr. \"Swaziland\")", "Ethiopia", "Gabon", "Gambia", "Ghana", "Guinea", "Guinea-Bissau", "Ivory Coast", "Kenya",
...
def plot_global_rolling(daily_df: pd.DataFrame) -> None:
    fig = px.line(
        daily_df,
        y='7day_avg',
        title='Africa COVID-19: 7‑Day Rolling Average of New Cases',
...
if __name__ == "__main__":
    ...
    # Compare a few large African countries
    compare_list = ["South Africa", "Nigeria", "Egypt", "Kenya", "Ethiopia"]
